...
addArtist(artists, ['Abanoub Mekhail'], '1995-2022',['Full Stack Development'],'egyption',[' I have a background in customer service at Big Retail Chain. I am attending BloomTech to become a Frontend Developer.'] );
...
function artistByCountry(array, string){
  ...
  for (let i = 0; i < array.length; i++){
    ...
    nationalarry.push(array[i].name);
  }
  return nationalarry
}
